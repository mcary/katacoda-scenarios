Let's enhance the visual appearance of our Posts view with a primary goal
of making it easier to digest the information on the page.
...
1. Install `bootstrap` rubygem:
   ...
   (The `bootstrap` gem depends on sassc, which takes a while to install.
   This command takes ~95 sec.)
...
We still haven't changed the post listing itself -- that's next!
